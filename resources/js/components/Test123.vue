...
export default {
    ...
    data: () => ({
        ...
        dialog: false,
        toShow: 'bowl',
        // image: 'https://www.tokyoweekender.com/wp-content/uploads/2018/01/japanese-toilet-small.jpg',
        image: 'http://sc04.alicdn.com/kf/H974dd26d48fb4a84a39f3d23cbafad04z.jpg',
        // faucet:'https://preview.redd.it/s5z9f6yh3cu11.jpg?auto=webp&s=e2ca669bafbea516602cf6dbdb54b360fc3ca80b',
        ...
        // towel: 'http://cdn.shopify.com/s/files/1/0451/8199/3123/products/wall-mount-towel-rack-black.jpg?v=1652174564',
        ...
        bowlColors: [
            {
                ...
                // bowlImage: require('../images/Shiyousho_Catalog/item_categories/トイレ_(REST ROOM)/color/ホワイト(white)/TBC001.jpg')
            },
            {
                id: 2,
                color: 'ebony',
                bowlImage: 'https://item-shopping.c.yimg.jp/i/l/biy-japan_xch1502eyb'
                // bowlImage: require('../images/Shiyousho_Catalog/item_categories/トイレ_(REST ROOM)/color/エボニー (ebony)/TBC002.jpg')
            },
            {
                id: 3,
                color: 'gold',
                bowlImage: 'https://item-shopping.c.yimg.jp/i/l/biy-japan_xch1501sn'
                // bowlImage: require('../images/Shiyousho_Catalog/item_categories/トイレ_(REST ROOM)/color/沙金 (sand_gold)/TBC004.jpg')
            },
            {
                id: 4,
                color: 'crimson',
                bowlImage: 'https://item-shopping.c.yimg.jp/i/l/kjk_xch1500bnbk'
                // bowlImage: require('../images/Shiyousho_Catalog/item_categories/トイレ_(REST ROOM)/color/紅殻色 (crimson_color)/TBC003.jpg')
            },
            {
                id: 5,
                color: 'copper',
        ...
        [
            ...
            },
            {
                ...
                // towel: 'https://d33eq77ly18scj.cloudfront.net/media/catalog/product/cache/9d712ef42fc6461913cee12c69c176af/1/1/1117258431_a.jpg',
                // image: 'https://i.pinimg.com/736x/57/01/cd/5701cdd8fd54f412313e5d3c9f8ea421.jpg'
            },
        ],
        ...
        getType: 'default',
        color: 'white',
        color_img: 'https://item-shopping.c.yimg.jp/i/l/kjk_xch1500wsk',
