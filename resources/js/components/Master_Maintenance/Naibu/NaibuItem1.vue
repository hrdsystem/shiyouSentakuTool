<template>
    <v-container fluid v-resize="onResize">
        <v-row no-gutter>
            <v-col cols="3">
                <v-btn rounded small outlined class="text-none mt-2" color="grey" to="/naibu_master">
        ...
        <v-row>
            <!-- = 1st Table = -->
            <v-col cols="6">
                <v-data-table hide-default-header :headers="headers" :items="mastersData" :items-per-page="10" class="elevation-1">
    ...
    export default {
        ...
        methods: {
            ...
            getNaibuItem1(){
                axios({
                    method:'get',
                    url:'api/masterMaintenance/getNaibuItem1',
                }).then((res)=>{
                    this.mastersData = res.data;
                    console.log(res.data, 'getNaibuItem1...')
                })
            },
            getItem2(item){
                this.item1Code = item
